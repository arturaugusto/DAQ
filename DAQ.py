...
class currentInput(Task):
    ...
    def __init__(self):
        ...
        self.CreateAICurrentChan( "cDAQ1Mod4/ai0",
                                  "",
        ...
        self.CfgSampClkTiming('',10000.0,DAQmx_Val_Rising, DAQmx_Val_ContSamps,20)
...
class voltageOutput(Task):
    ...
    def __init__(self):
        Task.__init__(self)
        self.CreateAOVoltageChan('cDAQ1Mod1/ao2','',0.0,10.0,DAQmx_Val_Volts,None)
